...
public class Notification {
    ...
    public void schedule() {
        android.util.Log.i("cocos2dnot", "notification schedule start");
        ...
        android.util.Log.i("cocos2dnot", "notification schedule end");
    }
    ...
    private void showNotification () {
        android.util.Log.i("cocos2dnot", "show");

        NotificationCompat.InboxStyle inboxStyle = new NotificationCompat.InboxStyle();
        inboxStyle.setBigContentTitle(options.getTitle());

        SharedPreferences prefs = context.getSharedPreferences("LocalNotificationSet", Context.MODE_PRIVATE);
        ...
        for (Integer id : ids) {
            String str = prefs.getString(id.toString(), null);
            if (str != null) {
                list.add(str);
            }
        }
        ...
        editor.putString(String.valueOf(list.size()), options.getText());
        editor.commit();
