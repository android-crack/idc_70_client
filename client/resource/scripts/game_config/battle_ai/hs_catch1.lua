...
local ClsAIHs_catch1 = class("ClsAIHs_catch1", ClsAIBase)

--------------------------- 基本属性函数开始 ------------------------------

-- AI ID
function ClsAIHs_catch1:getId()
	return "hs_catch1";
end


-- AI时机
function ClsAIHs_catch1:getOpportunity()
	return AI_OPPORTUNITY.TACTIC;
end

-- AI优先级别
function ClsAIHs_catch1:getPriority()
	return 1;
end
...
-- 本AI的判定条件
function ClsAIHs_catch1:checkCondition()
...
-- [备注]离场-[]
local function hs_catch1_act_2( ai_obj, act_obj, target, delta_time )
	local owner = ai_obj:getOwner();
	local battleData = getGameData():getBattleDataMt()
...
-- [备注]设置-[玩家到达1=玩家到达+1]
local function hs_catch1_act_0( ai_obj, act_obj, target, delta_time )
	local owner = ai_obj:getOwner();
	local battleData = getGameData():getBattleDataMt()
	...
	-- 公式原文:玩家到达1=玩家到达+1
	battleData:planningSetData("player_arrive1", player_arrive+1);
...
function ClsAIHs_catch1:getActions()
	return actions
end
...
function ClsAIHs_catch1:getAllTargetMethod()
	return all_target_method
end

return ClsAIHs_catch1
