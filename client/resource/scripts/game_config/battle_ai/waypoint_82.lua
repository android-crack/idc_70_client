...
local ClsAIWaypoint_82 = class("ClsAIWaypoint_82", ClsAIBase)

--------------------------- 基本属性函数开始 ------------------------------

-- AI ID
function ClsAIWaypoint_82:getId()
	return "waypoint_82";
end


-- AI时机
function ClsAIWaypoint_82:getOpportunity()
	return AI_OPPORTUNITY.TACTIC;
end

-- AI优先级别
function ClsAIWaypoint_82:getPriority()
	return 1;
end
...
-- 本AI的判定条件
function ClsAIWaypoint_82:checkCondition()
...
local actions = {
	...
	{"add_ai", "", {{"arrive_82", }, }, }, 
	{"delete_ai", "", {{"waypoint_82", }, }, }, 
}

function ClsAIWaypoint_82:getActions()
	return actions
end
...
function ClsAIWaypoint_82:getAllTargetMethod()
	return all_target_method
end

return ClsAIWaypoint_82
