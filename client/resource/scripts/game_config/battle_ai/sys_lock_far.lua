...
local ClsAISys_lock_far = class("ClsAISys_lock_far", ClsAIBase)

--------------------------- 基本属性函数开始 ------------------------------

-- AI ID
function ClsAISys_lock_far:getId()
	return "sys_lock_far";
end


-- AI时机
function ClsAISys_lock_far:getOpportunity()
	return AI_OPPORTUNITY.TACTIC;
end

-- AI优先级别
function ClsAISys_lock_far:getPriority()
	return 905;
end
...
-- 本AI的判定条件
function ClsAISys_lock_far:checkCondition()
...
local function sys_lock_far_act_0( ai_obj, act_obj, target, delta_time )
	local owner = ai_obj:getOwner();
	local battleData = getGameData():getBattleDataMt()
...
local actions = {
	{"op", targetFar, {sys_lock_far_act_0, }, }, 
	{"follow", "", {}, }, 
}

function ClsAISys_lock_far:getActions()
	return actions
end
...
function ClsAISys_lock_far:getAllTargetMethod()
	return all_target_method
end

return ClsAISys_lock_far
