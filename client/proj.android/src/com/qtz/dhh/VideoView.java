...
public class VideoView extends SurfaceView implements MediaPlayerControl,Callback {
	...
	public void setVideoURI(String videoFileName) {
		//mUri = uri;
		mVedioFileName = videoFileName;
	...
	private void openVideo() {
		...
		if (mVedioFileName == null || mSurfaceHolder == null) {
		...
		try {
			...
			AssetManager mAssetsManager = mContext.getAssets();
			AssetFileDescriptor mVideoDescriptor = mAssetsManager.openFd(mVedioFileName);
			mMediaPlayer.setDataSource(mVideoDescriptor.getFileDescriptor(),
					mVideoDescriptor.getStartOffset(),
					mVideoDescriptor.getLength());
