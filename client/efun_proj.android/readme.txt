dhh 项目android工程 准备流程：
   安装包或工具目录：
   \\192.168.0.251\上传专用文件夹\dhh
   \\192.168.0.251\上传专用文件夹\dhh\安卓编译打包
...
1.check quick-cocos2d-root目录：https://192.168.0.3/qtz/mg/common/quick_cocos2dx/gameplay3d_branch。

2.check client目录：https://192.168.0.3/qtz/mg01/program/client 


3.用控制台，进去client/proj.android目录，执行 android update -p "proj.androidpath" 指令。
