...
import static com.qtz.dhh.notification.Notification.PREF_KEY;
...
public class Manager {
     ...
     */
    public Notification schedule (JSONObject options) {
     ...
     */
    public Notification schedule (Options options) {
