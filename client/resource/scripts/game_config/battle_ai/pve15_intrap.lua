...
local ClsAIPve15_intrap = class("ClsAIPve15_intrap", ClsAIBase)

--------------------------- 基本属性函数开始 ------------------------------

-- AI ID
function ClsAIPve15_intrap:getId()
	return "pve15_intrap";
end


-- AI时机
function ClsAIPve15_intrap:getOpportunity()
	return AI_OPPORTUNITY.TACTIC;
end

-- AI优先级别
function ClsAIPve15_intrap:getPriority()
	return 48;
end
...
local function pve15_intrap_act_0( ai_obj, act_obj, target, delta_time )
	local owner = ai_obj:getOwner();
	local battleData = getGameData():getBattleDataMt()
...
local actions = {
	{"op", targetAllship, {pve15_intrap_act_0, }, }, 
}

function ClsAIPve15_intrap:getActions()
	return actions
end
...
function ClsAIPve15_intrap:getAllTargetMethod()
	return all_target_method
end

return ClsAIPve15_intrap
