...
local ClsAIBat_catch_81 = class("ClsAIBat_catch_81", ClsAIBase)

--------------------------- 基本属性函数开始 ------------------------------

-- AI ID
function ClsAIBat_catch_81:getId()
	return "bat_catch_81";
end


-- AI时机
function ClsAIBat_catch_81:getOpportunity()
	return AI_OPPORTUNITY.TACTIC;
end

-- AI优先级别
function ClsAIBat_catch_81:getPriority()
	return 48;
end
...
-- 本AI的判定条件
function ClsAIBat_catch_81:checkCondition()
...
-- [备注]设置-[玩家到达=玩家到达+1]
local function bat_catch_81_act_0( ai_obj, act_obj, target, delta_time )
	local owner = ai_obj:getOwner();
	local battleData = getGameData():getBattleDataMt()
...
local actions = {
	{"op", "", {bat_catch_81_act_0, }, }, 
	{"delete_ai", "", {{"bat_catch_81", }, }, }, 
}

function ClsAIBat_catch_81:getActions()
	return actions
end
...
function ClsAIBat_catch_81:getAllTargetMethod()
	return all_target_method
end

return ClsAIBat_catch_81
